function varargout = CodingApp14(varargin)
%CODINGAPP14 M-file for CodingApp14.fig
%      CODINGAPP14, by itself, creates a new CODINGAPP14 or raises the existing
%      singleton*.
%
%      H = CODINGAPP14 returns the handle to a new CODINGAPP14 or the handle to
%      the existing singleton*.
%
%      CODINGAPP14('Property','Value',...) creates a new CODINGAPP14 using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to CodingApp14_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      CODINGAPP14('CALLBACK') and CODINGAPP14('CALLBACK',hObject,...) call the
%      local function named CALLBACK in CODINGAPP14.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help CodingApp14

% Last Modified by GUIDE v2.5 07-Nov-2016 06:34:22

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CodingApp14_OpeningFcn, ...
                   'gui_OutputFcn',  @CodingApp14_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before CodingApp14 is made visible.
function CodingApp14_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for CodingApp14
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes CodingApp14 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = CodingApp14_OutputFcn(hObject, eventdata, handles)
