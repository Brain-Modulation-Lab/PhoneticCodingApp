...
if trial>0 && trial<=getappdata(0,'numTrials');
    ...
    if sum(cellfun('isempty',CodingMat(2:end,trial)))==0
        ...
        set(handles.edit12, 'String', CodingMat{8,trial}); 
        setappdata(0,'VowelOnset', CodingMat{9,trial});
        setappdata(0,'VowelOffset', CodingMat{10,trial}); 
    end
    ...
    [onset, h_onset, h_offset, h_Vonset, h_Voffset]= ...
        changeSpectrogram(AudioTrial, sf, getappdata(0, 'AudioOnset'), getappdata(0, 'AudioOffset'), ...
        getappdata(0, 'VowelOnset'), getappdata(0, 'VowelOffset'), ...
        getappdata(0, 'AudioSpeed'), handles);
...
%         AudioData.SkipEvents, trial, onset, offset, speed, handles);
    ...
    set(handles.radiobutton7, 'String', 'Token ID')
    set(handles.radiobutton6, 'String', 'Reveal Word')
