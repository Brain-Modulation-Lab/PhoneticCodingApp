function varargout = FinalCodingApp(varargin)
% FINALCODINGAPP MATLAB code for FinalCodingApp.fig
%      FINALCODINGAPP, by itself, creates a new FINALCODINGAPP or raises the existing
%      singleton*.
%
%      H = FINALCODINGAPP returns the handle to a new FINALCODINGAPP or the handle to
%      the existing singleton*.
%
%      FINALCODINGAPP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in FINALCODINGAPP.M with the given input arguments.
%
%      FINALCODINGAPP('Property','Value',...) creates a new FINALCODINGAPP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before FinalCodingApp_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to FinalCodingApp_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help FinalCodingApp

% Last Modified by GUIDE v2.5 27-Oct-2016 03:46:53

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @FinalCodingApp_OpeningFcn, ...
                   'gui_OutputFcn',  @FinalCodingApp_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before FinalCodingApp is made visible.
function FinalCodingApp_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to FinalCodingApp (see VARARGIN)

% Choose default command line output for FinalCodingApp
...
% so window can get raised using FinalCodingApp.
...
% UIWAIT makes FinalCodingApp wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = FinalCodingApp_OutputFcn(hObject, eventdata, handles)
